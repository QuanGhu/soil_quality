...
class PropertiesController extends Controller
{
    ...
    public function save(Request $request)
    {
        try {
            ...
            $validate = Validator::make($request->all(),[
                'code_name' => 'unique:soil_properties',
                'name' => 'unique:soil_properties'
            ]);
    ...
    public function update(Request $request)
    {
        try {
            ...
            $validate = Validator::make($request->all(),[
                'code_name' => 'unique:soil_properties,code_name,'.$request->id,
                'name' => 'unique:soil_properties,name,'.$request->id
            ]);
